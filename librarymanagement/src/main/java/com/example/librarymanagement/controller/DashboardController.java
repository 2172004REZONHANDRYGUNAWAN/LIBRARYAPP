...
import com.example.librarymanagement.Database;
import com.example.librarymanagement.LibraryManagement;
...
public class DashboardController implements Initializable {
    ...
    @FXML
    private TableView<Book> return_tableView;

    @FXML
    private TableColumn<Book, String> col_return_BookTitle;

    @FXML
    private TableColumn<Book, String> col_return_Author;

    @FXML
    private TableColumn<Book, String> col_return_bookType;

    @FXML
    private TableColumn<Book, String> col_return_dateIssue;
    ...
    @FXML
    private TableColumn<Book, String> col_saveTitle;

    @FXML
    private TableColumn<Book, String> col_saveAuthor;

    @FXML
    private TableColumn<Book, String> col_saveGenre;

    @FXML
    private TableColumn<Book, String> col_saveDate;
        ...
        try {
            ...
            if (take_BookTitle.getText().isEmpty()) {
                ...
                while (result.next()) {
                    ...
                    Book.path = result.getString("image");

                    String uri = "file:" + Book.path;
    ...
    public void studentNumberLabel() {
        take_StudentNumber.setText(Book.studentNumber);
    }
    ...
    public ObservableList<Book> Book() {
        ...
        ObservableList<Book> bookReturnData = FXCollections.observableArrayList();
        ...
        try {
            ...
            while (result.next()) {
                ...
                rBook = new Book(result.getString("bookTitle"), result.getString("author"),
    ...
    public void returnBooks() {
        ...
        String sql = "UPDATE take SET checkReturn = 'Returned' WHERE bookTitle = '" + Book.takeBookTitle + "'";
    ...
    private ObservableList<Book> retBook;
    ...
    public void selectReturnBook() {
        ...
        Book rBook = return_tableView.getSelectionModel().getSelectedItem();
        ...
        Book.takeBookTitle = rBook.getTitle();
    }
    ...
    public ObservableList<Book> savedBooksData() {

        ObservableList<Book> listSaveData = FXCollections.observableArrayList();

        String sql = "SELECT * FROM save WHERE studentNumber = '"+ Book.studentNumber +"'";
        ...
        try {
            ...
            while (result.next()) {
                ...
                sBook = new Book(result.getString("bookTitle"), result.getString("author"),
    ...
    private ObservableList<Book> sBookList;
    ...
    public void selectSavedBooks() {
        ...
        Book sBook = save_tableView.getSelectionModel().getSelectedItem();
        ...
        Book.savedImage = sBook.getImage();
        Book.savedTitle = sBook.getTitle();
    ...
    public void saveBooks() {
        ...
        try {
            ...
            if (availableBooks_title.getText().isEmpty()) {
                ...
                prepare = connect.prepareStatement(sql);
                prepare.setString(1, Book.studentNumber);
                prepare.setString(2, Book.savedTitle);
                prepare.setString(3, Book.savedAuthor);
                prepare.setString(4, Book.savedGenre);
                prepare.setString(5, Book.savedImage);
                prepare.setDate(6, Book.savedDate);
                prepare.executeUpdate();
    ...
    public void unsaveBooks() {
        ...
        String sql = "DELETE FROM save WHERE bookTitle = '" + Book.savedTitle + "'"
                + " and studentNumber = '" + Book.studentNumber + "'";
    ...
    public void selectAvailableBooks() {
        ...
        Book.takeBookTitle = bookData.getTitle();
        Book.savedTitle = bookData.getTitle();
        Book.savedAuthor = bookData.getAuthor();
        Book.savedGenre = bookData.getGenre();
        Book.savedImage = bookData.getImage();
        Book.savedDate = bookData.getDate();
    }
    ...
    public void studentNumber() {
        studentNumber_label.setText(Book.studentNumber);
    }
    ...
    public void logout(ActionEvent event) {
        try {
            if (event.getSource() == logout_btn) {
                Parent root = FXMLLoader.load(LibraryManagement.class.getResource("FXMLDocument.fxml"));
